...
module NIOS_mm_interconnect_0 (
		...
		output wire [3:0]  EPCQ_avl_csr_address,                   //                     EPCQ_avl_csr.address
		...
		output wire [21:0] EPCQ_avl_mem_address,                   //                     EPCQ_avl_mem.address
	...
	wire   [24:0] nios_data_master_translator_avalon_universal_master_0_address;              // NIOS_data_master_translator:uav_address -> NIOS_data_master_agent:av_address
	...
	wire  [112:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> NIOS_data_master_agent:rp_data
	...
	wire   [24:0] nios_instruction_master_translator_avalon_universal_master_0_address;       // NIOS_instruction_master_translator:uav_address -> NIOS_instruction_master_agent:av_address
	...
	wire  [112:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> NIOS_instruction_master_agent:rp_data
	...
	wire  [113:0] debug_avalon_jtag_slave_agent_rf_source_data;                               // DEBUG_avalon_jtag_slave_agent:rf_source_data -> DEBUG_avalon_jtag_slave_agent_rsp_fifo:in_data
	...
	wire  [113:0] debug_avalon_jtag_slave_agent_rsp_fifo_out_data;                            // DEBUG_avalon_jtag_slave_agent_rsp_fifo:out_data -> DEBUG_avalon_jtag_slave_agent:rf_sink_data
	...
	wire  [112:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> DEBUG_avalon_jtag_slave_agent:cp_data
	...
	wire   [24:0] epcq_avl_csr_agent_m0_address;                                              // EPCQ_avl_csr_agent:m0_address -> EPCQ_avl_csr_translator:uav_address
	...
	wire  [113:0] epcq_avl_csr_agent_rf_source_data;                                          // EPCQ_avl_csr_agent:rf_source_data -> EPCQ_avl_csr_agent_rsp_fifo:in_data
	...
	wire  [113:0] epcq_avl_csr_agent_rsp_fifo_out_data;                                       // EPCQ_avl_csr_agent_rsp_fifo:out_data -> EPCQ_avl_csr_agent:rf_sink_data
	...
	wire          cmd_mux_001_src_valid;                                                      // cmd_mux_001:src_valid -> EPCQ_avl_csr_agent:cp_valid
	wire  [112:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> EPCQ_avl_csr_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                      // EPCQ_avl_csr_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [5:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> EPCQ_avl_csr_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                              // cmd_mux_001:src_startofpacket -> EPCQ_avl_csr_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                // cmd_mux_001:src_endofpacket -> EPCQ_avl_csr_agent:cp_endofpacket
	...
	wire   [24:0] epcq_avl_mem_agent_m0_address;                                              // EPCQ_avl_mem_agent:m0_address -> EPCQ_avl_mem_translator:uav_address
	...
	wire  [113:0] epcq_avl_mem_agent_rf_source_data;                                          // EPCQ_avl_mem_agent:rf_source_data -> EPCQ_avl_mem_agent_rsp_fifo:in_data
	...
	wire  [113:0] epcq_avl_mem_agent_rsp_fifo_out_data;                                       // EPCQ_avl_mem_agent_rsp_fifo:out_data -> EPCQ_avl_mem_agent:rf_sink_data
	...
	wire          cmd_mux_002_src_valid;                                                      // cmd_mux_002:src_valid -> EPCQ_avl_mem_agent:cp_valid
	wire  [112:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> EPCQ_avl_mem_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                      // EPCQ_avl_mem_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [5:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> EPCQ_avl_mem_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                              // cmd_mux_002:src_startofpacket -> EPCQ_avl_mem_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                // cmd_mux_002:src_endofpacket -> EPCQ_avl_mem_agent:cp_endofpacket
	...
	wire   [24:0] nios_debug_mem_slave_agent_m0_address;                                      // NIOS_debug_mem_slave_agent:m0_address -> NIOS_debug_mem_slave_translator:uav_address
	...
	wire  [113:0] nios_debug_mem_slave_agent_rf_source_data;                                  // NIOS_debug_mem_slave_agent:rf_source_data -> NIOS_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [113:0] nios_debug_mem_slave_agent_rsp_fifo_out_data;                               // NIOS_debug_mem_slave_agent_rsp_fifo:out_data -> NIOS_debug_mem_slave_agent:rf_sink_data
	...
	wire  [112:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> NIOS_debug_mem_slave_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                      // NIOS_debug_mem_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [5:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> NIOS_debug_mem_slave_agent:cp_channel
	...
	wire  [113:0] ram_s1_agent_rf_source_data;                                                // RAM_s1_agent:rf_source_data -> RAM_s1_agent_rsp_fifo:in_data
	...
	wire  [113:0] ram_s1_agent_rsp_fifo_out_data;                                             // RAM_s1_agent_rsp_fifo:out_data -> RAM_s1_agent:rf_sink_data
	...
	wire  [112:0] cmd_mux_004_src_data;                                                       // cmd_mux_004:src_data -> RAM_s1_agent:cp_data
	...
	wire  [112:0] cmd_mux_005_src_data;                                                       // cmd_mux_005:src_data -> LED_s1_agent:cp_data
	...
	wire  [112:0] nios_data_master_agent_cp_data;                                             // NIOS_data_master_agent:cp_data -> router:sink_data
	...
	wire  [112:0] nios_instruction_master_agent_cp_data;                                      // NIOS_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [112:0] debug_avalon_jtag_slave_agent_rp_data;                                      // DEBUG_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [112:0] epcq_avl_csr_agent_rp_data;                                                 // EPCQ_avl_csr_agent:rp_data -> router_003:sink_data
	...
	wire  [112:0] epcq_avl_mem_agent_rp_data;                                                 // EPCQ_avl_mem_agent:rp_data -> router_004:sink_data
	...
	wire  [112:0] nios_debug_mem_slave_agent_rp_data;                                         // NIOS_debug_mem_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [112:0] ram_s1_agent_rp_data;                                                       // RAM_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [112:0] led_s1_agent_rp_data;                                                       // LED_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [112:0] cmd_demux_001_src0_data;                                                    // cmd_demux_001:src0_data -> cmd_mux_003:sink1_data
	...
	wire  [112:0] rsp_demux_003_src1_data;                                                    // rsp_demux_003:src1_data -> rsp_mux_001:sink0_data
	...
	wire          epcq_avl_csr_agent_rdata_fifo_src_valid;                                    // EPCQ_avl_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] epcq_avl_csr_agent_rdata_fifo_src_data;                                     // EPCQ_avl_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          epcq_avl_csr_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_001:in_0_ready -> EPCQ_avl_csr_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                          // avalon_st_adapter_001:out_0_valid -> EPCQ_avl_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                           // avalon_st_adapter_001:out_0_data -> EPCQ_avl_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                          // EPCQ_avl_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                          // avalon_st_adapter_001:out_0_error -> EPCQ_avl_csr_agent:rdata_fifo_sink_error
	wire          epcq_avl_mem_agent_rdata_fifo_src_valid;                                    // EPCQ_avl_mem_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] epcq_avl_mem_agent_rdata_fifo_src_data;                                     // EPCQ_avl_mem_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          epcq_avl_mem_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_002:in_0_ready -> EPCQ_avl_mem_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                          // avalon_st_adapter_002:out_0_valid -> EPCQ_avl_mem_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                           // avalon_st_adapter_002:out_0_data -> EPCQ_avl_mem_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                          // EPCQ_avl_mem_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                          // avalon_st_adapter_002:out_0_error -> EPCQ_avl_mem_agent:rdata_fifo_sink_error
