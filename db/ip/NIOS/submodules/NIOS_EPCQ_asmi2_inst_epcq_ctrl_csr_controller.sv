...
`timescale 1 ps / 1 ps
module NIOS_EPCQ_asmi2_inst_epcq_ctrl_csr_controller #(
	...
	localparam  CSR_MISC_EN_13  = 0;
	localparam  CSR_MISC_WR_ONLY_13 = 1;
	localparam  CSR_MISC_EN_14  = 0;
	localparam  CSR_MISC_WR_ONLY_14 = 0;
	localparam  CSR_MISC_EN_15  = 0;
	localparam  CSR_MISC_WR_ONLY_15 = 0;
	localparam  CSR_MISC_EN_16  = 0;
	...
	assign header_mem[13]	= 32'b00000000000010000000010000000000;
	assign header_mem[14]	= 32'b00000000000010000000100000000000;
	assign header_mem[15]	= 32'b00000000000001000000100000000000;
	assign header_mem[16]	= 32'b00000000000000000000000000000000;
...
// output_name 					: NIOS_EPCQ_asmi2_inst_epcq_ctrl_csr_controller
// op_info 			    		: wr_enable:32'b00000000000000000000000000000110,wr_disable:32'b00000000000000000000000000000100,wr_status:32'b00000000000001000000010000000001,rd_status:32'b00000000000001000000100000000101,block_erase:32'b00000000000000000000000111011000,sector_erase:32'b00000000000000000000000100100000,isr:32'b00000000000000000000000000000000,ier:32'b00000000000000000000000000000000,chip_select:32'b00000000000000000000000000000000,status:32'b00000000000000000000000000000000,NA:32'b00000000000000000000000000000000,NA:32'b00000000000000000000000000000000,NA:32'b00000000000000000000000000000000,NA:32'b00000000000010000000010000000000,NA:32'b00000000000010000000100000000000,NA:32'b00000000000001000000100000000000,NA:32'b00000000000000000000000000000000,bulk_erase/chip_erase:32'b00000000000000000000000011000111,NA:32'b00000000000000000000000000000000,NA:32'b00000000000000000000000000000000,NA:32'b00000000000000000000000000000000,sector_protect:32'b00000000000001000000010000000001,rd_memory_capacity_id:32'b00000000000011000000100010011111
// numb_common_op 				: 5
// common_op_offset 			: 0 1 2 3 4 5
// common_op_name   			: wr_enable wr_disable wr_status rd_status block_erase sector_erase
...
// misc_op_name   				: NA NA NA NA bulk_erase/chip_erase NA NA NA sector_protect rd_memory_capacity_id
// misc_op_opcode 				: 00 00 00 00 C7 00 00 00 01 9F
